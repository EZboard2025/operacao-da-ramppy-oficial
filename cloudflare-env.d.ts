/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: a45035711602e1aa2bec6e086b407833)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXTJS_ENV: string;
		AUTH_SECRET: string;
		WORKER_SELF_REFERENCE: Fetcher /* rampy */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "AUTH_SECRET">> {}
}
